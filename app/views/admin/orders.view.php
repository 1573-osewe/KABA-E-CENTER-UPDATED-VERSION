                ...
                <table id="example" class="table table-striped  ">
                  ...
                  <tbody onclick="show(event)">
                    ...
                    <tr class="text-start  ">
                        ...
                        <td><a href="<?php ?>"><?php echo esc($order->username)?? "" ?></a></td>
                        <td><?php echo date("jS m Y h:i a",strtotime($order->date))?></td>
                        <td><?php echo is_paid($order) ?? "<span class='badge bg-warning'>processing*</span>"?>
