                 ...
                 <?php  csrf()?>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        ...
                        <div>hapa <br><?php echo ROOT ?>/<?php echo ($row->image)?></div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="twitter_link" type="text" class="form-control" id="Twitter" value="<?php echo set_value('twitter_link', esc($row->twitter_link)) ?>">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="facebook_link" type="text" class="form-control" id="Facebook" value="<?php echo set_value('facebook_link', esc($row->facebook_link)) ?>">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="instagram_link" type="text" class="form-control" id="Instagram" value="<?php echo set_value('instagram_link', esc($row->instagram_link)) ?>">
